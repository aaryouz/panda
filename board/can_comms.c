...
bool can_pop(void *queue, CANPacket_t *packet);
void can_send(CANPacket_t *packet, uint8_t bus, bool enabled);
bool can_tx_check_min_slots_free(int slots);
void can_tx_comms_resume_usb(void);
void can_tx_comms_resume_spi(void);

// External variables
extern uint8_t dlc_to_len[];
extern void *can_rx_q;

// Constants
#define MIN(a, b) (((a) < (b)) ? (a) : (b))
#define CANPACKET_HEAD_SIZE 4U
#define MAX_CAN_MSGS_PER_USB_BULK_TRANSFER 4
#define MAX_CAN_MSGS_PER_SPI_BULK_TRANSFER 4
